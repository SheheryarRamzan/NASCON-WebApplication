<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminAdministratorEditForm.aspx.cs" Inherits="WebApplication2.AdminAdministratorEditForm" %>
                    ...
                    <td>
                        <asp:MultiView ID="MultiView1" runat="server" OnActiveViewChanged="MultiView1_ActiveViewChanged1">
                            ...
                            <asp:View ID="View1" runat="server">
                                ...
                                <br />
                                <br />
                                <asp:Button ID="Button2" runat="server" OnClick="Button2_Click1" style="position: absolute; top: 334px; left: 611px; z-index: 1;" Text="Modify" Width="78px" />
                                <br />
                                <asp:Button ID="Button3" runat="server" OnClick="Button3_Click" style="position: absolute; top: 333px; left: 879px; z-index: 1;" Text="Delete" Width="78px" />
                                <br />
                                <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" style="position: absolute; top: 334px; left: 342px; z-index: 1;" Text="Add" Width="78px" />
                                <br />
                            </asp:View>
